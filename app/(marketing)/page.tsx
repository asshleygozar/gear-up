	...
	return (
		<div className='flex flex-col gap-15 justify-between'>
			<nav className='flex justify-between items-center gap-10 h-[70px] py-[1rem] px-[3.5rem] shadow-md'>
				<h1 className='text-header text-2xl font-quick-sand font-bold cursor-pointer self-start'>
					Gear<span className='text-brand-foreground'>Up</span>
				</h1>
				<ul className='flex gap-5'>
					<Link href={'/features'}>
						<li className='text-sub-head font-inter font-semibold cursor-pointer'>
							Features
						</li>
					</Link>
					<Link href={'/about'}>
				...
				<div className='flex gap-5 self-end'>
					<Link href={'/signin'}>
						<Button className='font-quick-sand font-medium cursor-pointer'>
							Sign in
						</Button>
					</Link>
					<Link href={'/signup'}>
					...
					<section className='flex flex-col gap-4'>
						...
						<div className='flex gap-5'>
							...
							<Link href={'/'}>
								<Button
									variant={'outline'}
									className='font-inter text-lg px-[2rem] py-[1.5rem]'
								>
									See demo
								</Button>
							</Link>
